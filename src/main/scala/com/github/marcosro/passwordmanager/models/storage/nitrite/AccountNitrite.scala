package com.github.marcosro.passwordmanager.models.storage.nitrite
...
private object AccountNitrite {
  ...
  /** A find account by field on database (similar to SQL select)
    * @param field The account field to search like: search account by category, show accept values in [[com.github.marcosro.passwordmanager.models.storage.commands.Find]]
