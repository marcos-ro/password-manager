package com.github.marcosro.passwordmanager.models.storage
...
package commands {
  ...
  /** A companion by class [[com.github.marcosro.passwordmanager.models.storage.commands.FindAccountByField]]
  ...
  /** A class represent a find account by field command (similar to SQL select) take `field` when `field` is a enum into [[com.github.marcosro.passwordmanager.models.storage.commands.Find]] companion and `value` is a search value to match on database or file
    *
...
package programs {
  import com.github.marcosro.passwordmanager.models.storage.commands.Command
...
import com.github.marcosro.passwordmanager.models.storage.programs.Program

/** A companion by class [[com.github.marcosro.passwordmanager.models.storage.Storage]]
...
trait Storage {
  ...
  /** A abstract storage interpreter that run storage programs
    ...
    * @return If execution of storage program is ok return `T` when other case return [[com.github.marcosro.passwordmanager.models.storage.Storage.StorageError]]
    */
