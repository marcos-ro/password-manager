package com.github.passwordmanager.models.crypto
...
package programs {
  import com.github.passwordmanager.models.crypto.commands.Command
...
import com.github.passwordmanager.models.crypto.programs.Program

/** A companion by class [[com.github.passwordmanager.models.crypto.Crypto]]
...
trait Crypto {
  ...
  /** A abstract crypto interpreter that run crypto programs
    ...
    * @return If execution of crypto program is ok return `T` when other case return [[com.github.passwordmanager.models.crypto.Crypto.CryptoError]]
    */
